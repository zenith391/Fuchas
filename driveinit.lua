...
-- then it would be unable to boot. However, due to the 512 bytes restriction imposed by the only current standard: advancedLoader (and 1K restriction by my future OCFS), it's the only possible way
local cp=component
